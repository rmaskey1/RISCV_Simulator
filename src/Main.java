...
public class Main {
    ...
    int[] register = new int[32];        // RISC-V registeristers x0 to x31
    private ArrayList<Instruction> instructions;  // Array of all instructions instructions
     ...
     */
    public Main(Memory memory, ArrayList<Instruction> instructions) {
